...
module.exports = {
	...
	var SourcePerformerMap = new Schema({
		sourceId:String,
		universalToSource:{},
		sourceToUniversal:{},
		created: {type: Date,default:Date.now},
		updated: Date,
	    },{collection:'sourcePerformerMap'});

	SourcePerformerMap.pre('save', function(next) {
	...
	return mongoose.model('sourcePerformerMap',SourcePerformerMap);
